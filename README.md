🐦 X Clone API – .NET 8 RESTful Backend

Una API REST completa inspirada en X (Twitter), desarrollada con ASP.NET Core 8, Entity Framework Core, y C# siguiendo los principios de Clean Architecture.
Incluye autenticación JWT, validación con FluentValidation, y endpoints organizados en módulos (Auth, Users, Posts, Feed).
...
POST	/api/posts/{id}/repost	Repostear.
